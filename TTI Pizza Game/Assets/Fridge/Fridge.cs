...
public class Fridge : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!open)
        {
            Collider[] colliders = Physics.OverlapBox(new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.5f), new Vector3(1, 2, 1), Quaternion.identity);
    ...
    void OnDrawGizmos()
    {
        ...
        Vector3 center = new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.5f);
